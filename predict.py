...
parser.add_argument('--data_folder', dest='data_folder', type=str, default='dataset_dxy', help='folder to all data')
...
slot_set = text_to_dict('{}/slot_set_dxy.txt'.format(data_folder))
sym_dict = text_to_dict('{}/symptoms_dxy.txt'.format(data_folder))  # all symptoms
dise_dict = text_to_dict('{}/diseases_dxy.txt'.format(data_folder))
